...
# define path variables
	...
	cp="${activation}:${arq}:${aterm}:${axis}:${axis2}:${commonsdiscovery}:${icu4j}:${iri}:${jaws}:${jaxrpcapi}:${jcloverslf4j}:${jena}:${jgraphtjdk1}:${junit}:${jws}:${log4j}:${lucenecore}:${mataws}:${owlsapi}:${pellet}:${relaxngDatatype}:${saajapi}:${sine}:${slf4japi}:${slf4jlog4j12}:${staxapi}:${upnp}:${wstxasl}:${xercesImpl}:${xsdlib}"
