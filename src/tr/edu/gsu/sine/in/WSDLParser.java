...
/**
 * Provides support for parsing WSDL files.
 */
public class WSDLParser extends AbstractWSDLParser {

	/**
	 * The WSDL document to be parsed.
	 */
	private Document document;
	
	/**
	 * The service to be built from the WSDL document.
	 */
	...
	/**
	 * Complex type name to set of elements
	 */
	private Map<String, Set<String>> complexTypes;
	...
	private void initTables() {
		...
		complexTypes = new HashMap<String, Set<String>>();
	...
	/**
	 * Parses a WSDL document and returns the described service.
	 * <p>
	 * Here is an overview of the algorithm:
	 * <ul>
	 * <li>retrieve service name and location</li>
	 * <li>retrieve simple and complex types</li>
	...
	private void parseSimpleType(Element simpleTypeElem) {
		...
		if (!simpleTypes.add(name)) {
			logWarning("simpleType is defined twice: " + name);
		}
	}
	...
	private void parseComplexType(Element complexTypeElem)
		...
		if (complexTypes.containsKey(name)) {
			logWarning("complexType is defined twice: " + name);
		} else {
			complexTypes.put(name, new HashSet<String>());
