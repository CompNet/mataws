...
/**
 * This class uses WordNet to identify the synset corresponding
 * to some word.
 *  
 * @author Vincent Labatut
 */
public class WordNetIdentifier implements IdentifierInterface
{
	/**
	 * Builds and initialize an identifier
	 * relying on Jaws to access WordNet.
	 * (Could be easily extended to other
	 * libraries). 
	 */
	public WordNetIdentifier()
	{	initJaws();
	}
	...
	{	jawsObject = JawsTools.getAccess();
	}
	
	@Override
	public List<IdentifiedWord> identify(List<String> strings)
