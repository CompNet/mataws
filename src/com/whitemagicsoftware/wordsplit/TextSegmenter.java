 ...
 * @throws IOException 
  ...
  private double getProbability( String s ) {
	 ...
	 * @return
	 * 		A list of the resulting substring.
	 * 
	 * @author	Vincent Labatut
	 */
	public List<String> split(String string)
	{	String temp[] = segments(string).split(" ");
   ...
   */
  public String segments( String concat ) {
...
private void swap( List l1, List l2 ) {
  ...
  private void loadLexicon( BufferedReader lexiconData )
	...
	/**
	 * Loads the lexicon once and for all.
	 * 
	 * @param path
	 * 		Path of the lexicon.
	 * @throws IOException
	 * 		Problem while loading the lexicon.
	 * 
	 * @author Vincent Labatut
	 */
	...
	{	FileInputStream fis =  new FileInputStream(path); 
		...
		BufferedReader lex = new BufferedReader(isr);
		loadLexicon(lex);
		lex.close();
	}
