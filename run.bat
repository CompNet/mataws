...
:: define path variables
	...
	Set mataws=.\lib\mataws-1.0.0.jar
	...
	Set cp=%activation%;%arq%;%aterm%;%axis%;%axis2%;%commons-discovery%;%icu4j%;%iri%;%jaxrpc-api%;%jcl-over-slf4j%;%jena%;%jgrapht-jdk1%;%junit%;%log4j%;%lucene-core%;%mataws%;%owls-api%;%pellet%;%relaxngDatatype%;%saaj-api%;%sine%;%slf4j-api%;%slf4j-log4j12%;%stax-api%;%upnp%;%wstx-asl%;%xercesImpl%;%xsdlib%
